...
Pod::Spec.new do |spec|
  ...
  spec.vendored_frameworks 	  = 'Sources/TencentOpenApi/TencentOpenAPI.framework'
  spec.resource               = 'Sources/TencentOpenApi/TencentOpenApi_IOS_Bundle.bundle'
  spec.frameworks             = 'Security', 'SystemConfiguration', 'CoreTelephony', 'CoreGraphics'
